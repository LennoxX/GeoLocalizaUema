...
public class Coordenadas {
    ...
    public static final LatLng COORDENADA_PREDIO_PROG = new LatLng(-2.5770448, -44.2098678);
    public static final LatLng COORDENADA_PREDIO_PROPLAN = new LatLng(-2.5794305, -44.2071593);

    public static final LatLng COORDENADA_PARADA_1 = new LatLng(-2.5754948, -44.2097314);
    public static final LatLng COORDENADA_PARADA_2 = new LatLng(-2.5759336, -44.2081575);
    public static final LatLng COORDENADA_PARADA_3 = new LatLng(-2.5766027, -44.2063583);
    public static final LatLng COORDENADA_PARADA_4 = new LatLng(-2.578711, -44.2066066);
    public static final LatLng COORDENADA_PARADA_5 = new LatLng(-2.579843, -44.2067284);
    public static final LatLng COORDENADA_PARADA_6 = new LatLng(-2.5825161, -44.2070116);
    public static final LatLng COORDENADA_PARADA_FINAL = new LatLng(-2.5830948, -44.208644);
